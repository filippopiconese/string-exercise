...
test('negative numbers are not allowed n. 2', t => {
  ...
  const errorMessage = t.throws((_avaThrowsHelperStart(t, 'throws', '/home/filippo/workspace/string-exercise/test.js', 52), _avaThrowsHelperEnd(t, () => {
    stringCalculator('//-\n1-4--1001-6-5');
  })));
  t.true(_rec3._expr(_rec3._capt(_rec3._capt(_rec3._capt(errorMessage, 'arguments/0/left/object').message, 'arguments/0/left') === 'negatives not allowed: -1001', 'arguments/0'), {
    content: 't.true(errorMessage.message === \'negatives not allowed: -1001\')',
    filepath: 'test.js',
    line: 53,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"BinaryExpression","operator":"===","left":{"type":"MemberExpression","object":{"type":"Identifier","name":"errorMessage","range":[7,19]},"property":{"type":"Identifier","name":"message","range":[20,27]},"computed":false,"range":[7,27]},"right":{"type":"StringLiteral","value":"negatives not allowed: -1001","range":[32,62]},"range":[7,62]}],"range":[0,63]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"errorMessage","range":[7,19]},{"type":{"label":"."},"range":[19,20]},{"type":{"label":"name"},"value":"message","range":[20,27]},{"type":{"label":"==/!="},"value":"===","range":[28,31]},{"type":{"label":"string"},"value":"negatives not allowed: -1001","range":[32,62]},{"type":{"label":")"},"range":[62,63]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
});
...
//# sourceMappingURL=/home/filippo/workspace/string-exercise/node_modules/.cache/ava/20771f609250c4666510a12fef9531c8.js.map