...
test('negative numbers are not allowed - 1', t => {
  t.is(stringCalculator('1,4,-1'), new Error(`negatives not allowed: -1`), `The string return ${stringCalculator('1,4,-1')} instead of negatives not allowed: -1`);
});

// test('negative numbers are not allowed - 2', t => {
//   t.is(stringCalculator('//-\n1-2-5\n7-9'), 24, `The string return ${stringCalculator('//-\n1-2-5\n7-9')} instead of 24`)
// })
//# sourceMappingURL=/home/filippo/workspace/string-exercise/node_modules/.cache/ava/94d47aecc41db3fd60446ae8c04de85a.js.map