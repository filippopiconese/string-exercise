...
test('negative numbers are not allowed - 1', t => {
  ...
  }))); // { message: `negatives not allowed: -1` }, `The string return ${stringCalculator('1,4,-1')} instead of negatives not allowed: -1`)
  t.true(_rec._expr(_rec._capt(_rec._capt(_rec._capt(errorMessage, 'arguments/0/left/object').message, 'arguments/0/left') === 'negatives not allowed: -5', 'arguments/0'), {
    content: 't.true(errorMessage.message === \'negatives not allowed: -5\')',
    filepath: 'test.js',
    line: 39,
    ast: '{"type":"CallExpression","callee":{"type":"MemberExpression","object":{"type":"Identifier","name":"t","range":[0,1]},"property":{"type":"Identifier","name":"true","range":[2,6]},"computed":false,"range":[0,6]},"arguments":[{"type":"BinaryExpression","operator":"===","left":{"type":"MemberExpression","object":{"type":"Identifier","name":"errorMessage","range":[7,19]},"property":{"type":"Identifier","name":"message","range":[20,27]},"computed":false,"range":[7,27]},"right":{"type":"StringLiteral","value":"negatives not allowed: -5","range":[32,59]},"range":[7,59]}],"range":[0,60]}',
    tokens: '[{"type":{"label":"name"},"value":"t","range":[0,1]},{"type":{"label":"."},"range":[1,2]},{"type":{"label":"true"},"value":"true","range":[2,6]},{"type":{"label":"("},"range":[6,7]},{"type":{"label":"name"},"value":"errorMessage","range":[7,19]},{"type":{"label":"."},"range":[19,20]},{"type":{"label":"name"},"value":"message","range":[20,27]},{"type":{"label":"==/!="},"value":"===","range":[28,31]},{"type":{"label":"string"},"value":"negatives not allowed: -5","range":[32,59]},{"type":{"label":")"},"range":[59,60]}]',
    visitorKeys: _powerAssertVisitorKeys
  }));
});
//# sourceMappingURL=/home/filippo/workspace/string-exercise/node_modules/.cache/ava/b5c8de8b3a49df9b9ce2572dcd2b19dd.js.map